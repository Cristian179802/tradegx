...
const st = StyleSheet.create({
  ...
  directieText: { flex: 1, color: T.ink.i2, fontSize: T.fontSize.sm, fontWeight: "600" , fontFamily: "Inter_600SemiBold" },
  live: {
  ...
  textLive: { color: T.accent.base, fontSize: 10, fontWeight: "800", letterSpacing: T.tracking.wide , fontFamily: "Inter_800ExtraBold" },
  eticheta: {
  ...
  valoareRand: { color: T.ink.i1, fontSize: T.fontSize.base, fontWeight: "700" , fontFamily: "Inter_700Bold" },
