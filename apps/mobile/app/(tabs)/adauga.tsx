...
const st = StyleSheet.create({
  ...
  textDirectie: { fontSize: T.fontSize.base, fontWeight: "700" },
  ...
  riscEticheta: { color: T.ink.i4, fontSize: 10, textTransform: "uppercase", letterSpacing: T.tracking.wide },
  riscValoare: { color: T.ink.i2, fontSize: T.fontSize.sm, fontWeight: "800" },
  explicatie: { color: T.ink.i3, fontSize: T.fontSize.xs, marginTop: 6, lineHeight: 17 },
  foloseste: {
  ...
  textFoloseste: { color: T.accent.base, fontSize: T.fontSize.sm, fontWeight: "700" },
  ...
  notaIesire: { color: T.ink.i4, fontSize: T.fontSize.xs, marginTop: -8, marginBottom: T.spacing.md },
  cutieEroare: {
