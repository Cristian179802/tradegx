...
const st = StyleSheet.create({
  ...
  textDirectie: { fontSize: T.fontSize.base, fontWeight: "700" , fontFamily: "Inter_700Bold" },
  ...
  riscValoare: { color: T.ink.i2, fontSize: T.fontSize.sm, fontWeight: "800" , fontFamily: "Inter_800ExtraBold" },
  ...
  textFoloseste: { color: T.accent.base, fontSize: T.fontSize.sm, fontWeight: "700" , fontFamily: "Inter_700Bold" },
