        ...
        sections: [
          ...
          },
          {
            ...
            lab: {
              ...
              overlays: ["smc", "ema50"],
              focus: {
                ro: "Zonele verzi și roșii sunt order block-uri detectate automat, iar liniile galbene punctate sunt lichiditate. Uită-te ce a făcut prețul când s-a întors în ele: a fost respins, sau a trecut prin ele ca prin aer? Ambele se întâmplă — iar diferența e lecția.",
                en: "The green and red zones are automatically detected order blocks; the dashed yellow lines are liquidity. Look at what price did when it came back into them: was it rejected, or did it slice straight through? Both happen — and the difference is the lesson.",
              },
            },
            body: {
