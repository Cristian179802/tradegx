  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        {/* Calculator form */}
        <div className="tg-panel border rounded-2xl p-6 animate-pulse space-y-5">
        ...
        <div className="space-y-4">
          {/* Main result */}
          <div className="tg-panel border rounded-2xl p-6 animate-pulse">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="tg-panel border rounded-xl p-4 animate-pulse"
          ...
          {/* Info card */}
          <div className="tg-panel border rounded-2xl p-4 animate-pulse space-y-2">
