  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="h-28 tg-panel border rounded-2xl p-4 space-y-3 animate-pulse">
            <div className="flex items-center justify-between">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        {[1, 2].map((i) => (
          <div key={i} className="h-72 tg-panel border rounded-2xl p-5 animate-pulse">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="lg:col-span-2 h-64 tg-panel border rounded-2xl animate-pulse" />
        <div className="h-64 tg-panel border rounded-2xl animate-pulse" />
      </div>
    </div>
  );
}
